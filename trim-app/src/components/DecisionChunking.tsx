...
export default function DecisionChunking({
  ...
  return (
    <div className="bg-cardBg rounded-lg mt-6 shadow border border-stretchLimo/10">
      {/* Section Header */}
      <div className="flex items-center justify-between px-4 py-3 hover:bg-cloudDancer/30 transition-colors">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={chunkingInfoRef}>
            ...
            {showChunkingInfo && (
              <div className="absolute right-0 top-full mt-2 bg-cardBg shadow-lg border border-stretchLimo/10 max-w-xs rounded-lg p-4 z-50">
