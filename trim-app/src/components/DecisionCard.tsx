...
export default function DecisionCard({ decision, onClick, onDelete, onUpdateDecision, onTrim, onReopen, level = 0, children, hasChildren = false, isExpanded = true, onToggleExpand }: DecisionCardProps) {
  ...
  const getBackgroundColor = () => {
    return '#F5F3F0'; // cardBg - Cloud Dancer보다 약간 밝지만 같은 따뜻한 톤
  };
  ...
  const getBorderStyle = () => {
    return '1px solid rgba(26, 26, 26, 0.10)'; // 미세한 테두리로 경계감 보완
  };
          ...
          <>
            ...
            <div
              ...
              style={{
                ...
                width: '2px',
                height: '14px',
                backgroundColor: 'rgba(26, 26, 26, 0.50)', // stretchLimo/50
              }}
            />
            {/* 가로선 */}
            <div
