...
export default function DecisionDetail({ decision, decisions, categories, initialSubDecisionCount: propInitialSubDecisionCount, onBack, onUpdate, onDelete, onCreateSubDecision, onSelectDecision, onReorderSubDecisions }: DecisionDetailProps) {
  ...
  return (
    <div className="min-h-screen bg-cloudDancer">
      {/* Header */}
      <header className="sticky top-0 z-10 bg-warmWhite border-b-2 border-stretchLimo500 px-4 py-3 flex items-center justify-between">
      ...
      <div className="max-w-2xl mx-auto px-4 pt-3 pb-24">
        ...
        {/* Settings Section */}
        <div className="bg-warmWhite rounded-lg divide-y divide-stretchLimo300 border border-stretchLimo400 shadow-md -mt-2">
          {/* Importance */}
          <div className="relative">
            <button
            ...
            {showImportanceDropdown && (
              <div className="absolute top-full left-0 right-0 bg-warmWhite border-t border-stretchLimo200 shadow-lg z-10">
        ...
        <div className="relative bg-warmWhite rounded-lg border border-stretchLimo400 shadow-md">
