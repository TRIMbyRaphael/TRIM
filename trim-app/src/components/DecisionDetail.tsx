              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    disabled={localDecision.resolved}
                    className={`w-full px-3 py-1.5 text-sm text-cloudDancer placeholder:text-xs placeholder-white/50 bg-white/10 border border-white/20 rounded-lg outline-none focus:ring-2 focus:ring-white/50 resize-none overflow-hidden ${
