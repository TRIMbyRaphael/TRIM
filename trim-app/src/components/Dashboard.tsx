      ...
      <div className="max-w-2xl mx-auto px-4 pb-8">
          ...
          <section className="mb-6">
            ...
            >
              <div className="flex items-center gap-2 w-full">
                <h2 className="flex-1 text-left text-lg font-semibold text-stretchLimo/80">{t.sampleDecisionsSection}</h2>
        ...
        >
          <section className="mb-6">
            ...
            >
              <div className="flex items-center gap-2 w-full">
                <h2 className="flex-1 text-left text-lg font-bold text-black">{t.active}</h2>
        ...
        {resolvedDecisions.length > 0 && (
          <section className="mb-6">
            ...
            >
              <div className="flex items-center gap-2 w-full">
                <h2 className="flex-1 text-left text-lg font-bold text-black">{t.resolved}</h2>
