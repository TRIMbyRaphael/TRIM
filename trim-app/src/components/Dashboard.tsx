            ...
            {expandedSections.active && (
              <>
                ...
                <button
                  ...
                  className="w-full bg-green-500 rounded-lg p-4 mb-3 flex items-center gap-3 border border-stretchLimo/10 hover:bg-green-600 transition-shadow shadow hover:shadow-md"
                >
