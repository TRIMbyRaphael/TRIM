  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 md:inset-0 md:flex md:items-center md:justify-center z-50">
        <div className="bg-cardBg rounded-t-2xl md:rounded-2xl w-full md:max-w-lg md:max-h-[90vh] overflow-y-auto shadow-lg">
          {/* Header */}
          <div className="flex justify-end p-4 border-b border-stretchLimo/10">
            <button
              onClick={onClose}
      ...
      {showTimePicker && (
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50">
            <div className="bg-cardBg rounded-2xl w-80 p-6 shadow-lg">
              <div className="flex items-center justify-between mb-4">
