...
function createEnglishSamples(now: Date): SampleData {
  const decisions: Decision[] = [
    // ─── Decision 1: Adding a routine (choose_best, MEDIUM) ───
    {
      ...
      keyFactors: [
        { id: 'example-1-kf-1', criteria: 'Cost', importance: 3 },
        { id: 'example-1-kf-2', criteria: 'Sustainability', importance: 5 },
        { id: 'example-1-kf-3', criteria: 'Health benefits', importance: 4 },
        { id: 'example-1-kf-4', criteria: 'Time efficiency', importance: 3 },
      ],
      order: 0,
      mode: 'choose_best',
      isExample: true,
